...
fig1_ax1.plot(loss_train)
fig1_ax1.set_title('Training Loss and Bit Accuracy')
fig1_ax1.set_xlabel('Iteration x 100')
fig1_ax1.set_ylabel('Training loss')
fig1_ax1.set_yscale('log')
fig1_ax1.set_ylim(0,20000)


fig1_ax2 = fig1.add_subplot(212)
fig1_ax2.plot(loss_train)
fig1_ax2.set_xlabel('Iteration x 100')
fig1_ax2.set_ylabel('Correct bits')
fig1_ax2.set_yscale('log')
fig1_ax2.set_ylim(0,20000)
...
for i_snr in range(num_snr):
    ...
    for i in range(test_iter):
        ...
        if i % 100 == 0:
            correct_bits_test = eq2.eval(feed_dict={NNinput: batch_Y, org_siganl: batch_X, batchSize: B})
            test_loss = accuracy.eval(feed_dict={NNinput: batch_Y, org_siganl: batch_X, batchSize: B})
            print("Test loss:",test_loss,"Correct bits:",correct_bits_test )
...
'''
fig = plt.figure(2)
ax = fig.title('BER vs SNR')
plt.plot(snrdb_list,bers[0])
plt.ylabel('BER')
plt.xlabel('SNR(dB)')
plt.show()
'''
